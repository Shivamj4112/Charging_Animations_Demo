...
class DefaultAnimationActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDefaultAnimationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityDefaultAnimationBinding.inflate(layoutInflater)
        ...
        binding.apply {
            ...
            btApply.setOnClickListener {
                ...
                editor.apply()
                startService(Intent(this@DefaultAnimationActivity, Service::class.java))

            }

            ivOpenSettings.setOnClickListener {

                startActivity(Intent(this@DefaultAnimationActivity, SettingsActivity::class.java))
            }
